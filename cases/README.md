...
- `Subtype`: The [subtypes](##Targets-and-sources) of each root causes. e.g., the subtypes of constraint violation are syntax error, invalid option name, misplaced configuration, duplicate option, and multi-configuration error.
